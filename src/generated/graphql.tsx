...
export type PostCommentMutation = { __typename?: "Mutation" } & {
    postComment: { __typename?: "CommentPostedReponse" } & Pick<
...
export type TriggerUserTweetQuery = { __typename?: "Query" } & Pick<
    Query,
    "triggerUserTweetsSubscriptions"
>;
...
export type GetCommentsQuery = { __typename?: "Query" } & {
    getComments: { __typename?: "GetCommentsResponse" } & Pick<
        GetCommentsResponse,
        "error"
    > & {
            comments: Array<
                { __typename?: "CommentRespose" } & Pick<
                    CommentRespose,
                    | "comment_id"
                    | "commentMsg"
                    | "profileImg"
...
export type GetFollowInfoQuery = { __typename?: "Query" } & {
    ...
    > & {
            profile: { __typename?: "ProfileItems" } & Pick<
                ProfileItems,
                "followers" | "following" | "isFollowed"
            >;
        };
};
...
export type GetPaginatedPostsQuery = { __typename?: "Query" } & {
    getPaginatedPosts: { __typename?: "GetPaginatedFeedTweets" } & Pick<
        GetPaginatedFeedTweets,
        "error"
    > & {
            tweets: Array<
                { __typename?: "GetOneTweet" } & Pick<
                    GetOneTweet,
                    | "tweet_id"
                    | "tweet_content"
                    | "created_At"
...
export type GetPaginatedUserTweetsQuery = { __typename?: "Query" } & {
    getPaginatedUserTweets: { __typename?: "GetPaginatedUserTweets" } & Pick<
...
export type GetProfileQuery = { __typename?: "Query" } & {
    getUserProfile: { __typename?: "GetProfile" } & Pick<
        GetProfile,
        "error"
    > & {
...
export type ProfileStuffAndUserTweetsQuery = { __typename?: "Query" } & {
...
export type GetTweetsByUserQuery = { __typename?: "Query" } & {
    getTweetsByUser: { __typename?: "GetFeedTweets" } & Pick<
        GetFeedTweets,
        "error" | "num"
    > & {
            tweets?: Maybe<
...
export type GetUserByUsernameQuery = { __typename?: "Query" } & {
    getUserByUsername: { __typename?: "NUserResponse" } & {
        user: { __typename?: "NUser" } & Pick<
            NUser,
            "id" | "username" | "name" | "img"
        >;
    };
};
...
export type ListenUserTweetsSubscription = { __typename?: "Subscription" } & {
    listenUserTweets: { __typename?: "SubUserTweets" } & Pick<
        SubUserTweets,
        "error"
    > & {
            tweets?: Maybe<
...
export function useTriggerUserTweetQuery(
    options: Omit<
        Urql.UseQueryArgs<TriggerUserTweetQueryVariables>,
        "query"
    > = {}
) {
    return Urql.useQuery<TriggerUserTweetQuery>({
        query: TriggerUserTweetDocument,
        ...options,
    });
}
...
export function useGetCommentsQuery(
    options: Omit<Urql.UseQueryArgs<GetCommentsQueryVariables>, "query"> = {}
) {
    return Urql.useQuery<GetCommentsQuery>({
...
export function useGetFollowInfoQuery(
    options: Omit<Urql.UseQueryArgs<GetFollowInfoQueryVariables>, "query"> = {}
) {
    return Urql.useQuery<GetFollowInfoQuery>({
        query: GetFollowInfoDocument,
        ...options,
    });
}
...
export function useGetProfileImageQuery(
    options: Omit<
        Urql.UseQueryArgs<GetProfileImageQueryVariables>,
        "query"
    > = {}
) {
...
export function useGetProfileStuffQuery(
    options: Omit<
        Urql.UseQueryArgs<GetProfileStuffQueryVariables>,
        "query"
    > = {}
) {
...
export function useProfileStuffAndUserTweetsQuery(
    options: Omit<
        Urql.UseQueryArgs<ProfileStuffAndUserTweetsQueryVariables>,
        "query"
    > = {}
) {
    return Urql.useQuery<ProfileStuffAndUserTweetsQuery>({
        query: ProfileStuffAndUserTweetsDocument,
        ...options,
    });
}
...
export function useGetSearchResultsQuery(
    options: Omit<
        Urql.UseQueryArgs<GetSearchResultsQueryVariables>,
        "query"
    > = {}
) {
...
export function useGetTweetsByUserQuery(
    options: Omit<
        Urql.UseQueryArgs<GetTweetsByUserQueryVariables>,
        "query"
    > = {}
) {
...
export function useGetTweetsByUserFQuery(
    options: Omit<
        Urql.UseQueryArgs<GetTweetsByUserFQueryVariables>,
        "query"
    > = {}
) {
...
export function useGetUserByUsernameQuery(
    options: Omit<
        Urql.UseQueryArgs<GetUserByUsernameQueryVariables>,
        "query"
    > = {}
) {
    return Urql.useQuery<GetUserByUsernameQuery>({
...
export function useListenUserTweetsSubscription<
    TData = ListenUserTweetsSubscription
>(
    options: Omit<
        Urql.UseSubscriptionArgs<ListenUserTweetsSubscriptionVariables>,
        "query"
    > = {},
    handler?: Urql.SubscriptionHandler<ListenUserTweetsSubscription, TData>
) {
    return Urql.useSubscription<
        ListenUserTweetsSubscription,
        TData,
        ListenUserTweetsSubscriptionVariables
    >({ query: ListenUserTweetsDocument, ...options }, handler);
}
